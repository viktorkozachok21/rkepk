...
<div class="card news-line-item mb-1">
  <div class="card-body p-1 row">
    <div class="col-3 col-md-2 post-image text-center">
      <a onclick="${ post.link }" href="${ post.href }" target="${ post.target }">
        <img src="${ post.img }" alt="news-line" class="img-fruid m-0">
      </a>
    </div>
    <div class="col-9 col-md-10 pl-1">
      ...
      <p class="text-justify post-description m-0">${ post.description }</p>
